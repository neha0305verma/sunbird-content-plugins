...
org.ekstep.questionunitmcq.RendererPlugin = org.ekstep.contentrenderer.questionUnitPlugin.extend({
    ...
    evaluateQuestion: function(event) {
        ...
        if (!_.isUndefined(MCQController.pluginInstance._selectedIndex)) telValues['option' + MCQController.pluginInstance._selectedIndex] = selectedAnsData.text.length > 0 ? selectedAnsData.text : ""; // eslint-disable-line no-undef
        result = {
            eval: correctAnswer,
            state: {
    ...
    getTelemetryParams: function() {
        ...
        var instance = this;
        var params = [],
            questionData = MCQController.pluginInstance._question.data;
        var correctAnsIndex = [],
            answer = {};
    ...
    onOptionSelected: function(event, index) {
        ...
        telValues['option' + index] = value.text.length > 0 ? value.text : "";
