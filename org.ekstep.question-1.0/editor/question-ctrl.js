angular.module('org.ekstep.question', ['org.ekstep.metadataform'])
    .controller('QuestionCreationFormController', ['$scope', 'instance', 'questionData', function($scope, instance, questionData) {
        ...
        $scope.validatedForm = function(isFormValid, data) {
            if (isFormValid || $scope.templateId === "subjective") {
        ...
        $scope.setPreviewData = function() {
            var confData = {};
            debugger;
            if ($scope.templateId === "subjective") {
                $scope.questionCreationFormData.options[0].text = "<textarea name='answer' form='answerform' placeholder='Enter answer here...' style='width: 114.3%;height: 179px;margin-left: -18px;padding-left: 8px;'></textarea>";
            }
            var qObj = {
